...
$(document).ready(function () {
  ...
  // animates trackster while loading track results

  $(document).ajaxStart(function () {
    $("h1").addClass("load");
  });

  // turns off trackster animation when found results
...
Trackster.renderTracks = function (tracks) {
  ...
  for (i = 0; i < tracks.length; i++) {
    ...
    console.log("mediumAlbumArt", mediumAlbumArt);
    ...
    let htmlTrackInfo =
      ...
      track.url +
      '" target="_blank"><i class="far fa-play-circle fa-lg"></i></a></div>' +
      '<div  class="col-4">' +
      i +
      "&nbsp;" +
      track.name +
